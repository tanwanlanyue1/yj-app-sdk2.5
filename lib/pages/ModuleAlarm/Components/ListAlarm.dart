...
class ListAlarm extends StatelessWidget {
                                        ...
                                        children: <Widget>[
                                          Row(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Text(
                                                    alarmString(item['alarmType']),
                                                    style: TextStyle(
                                                        fontSize: sp(24.0),
                                                        color: Colors.black)
                                                ),
                                                item['warnStatus'] != null ?
                                                Text(
                                                    '${item['warnStatus'] == 2 ? '误判': ''}',
                                                    style: TextStyle(
                                                        fontSize: sp(24.0),
                                                        color: Colors.black)
                                                ):
  ...
  String alarmString(String str){
    switch(str) {
      case 'warning': return '预警报警'; break;
      case 'trend': return '趋势报警'; break;
      case 'stench': return '恶臭报警'; break;
      case 'accidentHazard': return '事故危害报警'; break;
      case 'source': return '固定污染源报警'; break;
      default:  return '';
    }
  }
}