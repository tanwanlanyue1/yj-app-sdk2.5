                  ...
                  FormCheck.fromCard(
                    child: Column(children: [
                      ...
                      FormCheck.formRowItem(
                          ...
                          title: '发布时间',
                          child:
                              FormCheck.textData(data: '2020-09-28  10:00:00')),
                    ]),
                  ),
                  /********监测点位设定********/
                  Row(
                            ...
                            child: InkWell(
                                ...
                                onTap: () {
                                  ...
                                  ToastWidget.showToastMsg(
                                      '新增成功，当前有${_monitoringTasks.length}个监测目标');
                                  setState(() {});
                                }))
                      ]),
                  Column(
                          ...
                          child: Column(children: [
                            ...
                            FormCheck.formRowItem(
                                ...
                                child: DownInput(
                                    ...
                                    callback: (val) {
                                      _monitoringTasks[index]['functional'] =
                                          val['value'];
                                      setState(() {});
                                    })),
                            FormCheck.formRowItem(
                                ...
                                child: DownInput(
                                    hitStr: '请选择相关人员',
                                    data: _peoples,
                                    value: _processorStr(_monitoringTasks[index]
                                        ['monitoringStaff']),
                                    more: true,
                                    callback: (val) {
                                      _monitoringTasks[index]
                                          ['monitoringStaff'] = val;
                                      setState(() {});
                                    })),
                            FormCheck.formRowItem(
                                ...
                                child: DownInput(
                                    ...
                                    more: true,
                                    data: _chemicalList,
                                    value: _monitoringTasks[index]['factor']
                                        .join(','),
                                    callback: (val) {
                                      List strList = [];
                                      val.forEach((item) {
                            ...
                            FormCheck.formRowItem(
                                ...
                                child: DownInput(
                                    hitStr: '请选择相关配置',
                                    value: _monitoringTasks[index]['instrument']
                                        .join(','),
                                    data: _equipmentList,
                                    more: true,
                                    callback: (val) {
                                      ...
                                      _monitoringTasks[index]['instrument'] =
                                          strList;
                                      setState(() {});
                                    })),
                            FormCheck.formRowItem(
