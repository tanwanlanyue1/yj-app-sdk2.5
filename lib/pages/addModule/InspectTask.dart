...
class _InspectTaskState extends State<InspectTask> {
  ...
  void _partitions() async {
    var response = await Request().get(Api.url['partitions'],);
    if(response['code'] == 200){
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          _verificationTasks.add(json.decode(json.encode(_item)));
                          ToastWidget.showToastMsg('新增成功，当前有${_verificationTasks.length}个核查目标');
                          setState(() {});
                        }
                      )
                    )
                        ...
                        children: [
                          ...
                          FormCheck.formRowItem(
                            ...
                            child: AccessLocate(
                              ...
                              hintStrl:_verificationTasks[index]['longitude']+','+_verificationTasks[index]['latitude'],
                            )
                          ),
                          FormCheck.formRowItem(
                            padding: false,
                            ...
                            child: DownInput(
                              hitStr: '请选择所在分区',
                              data: _partitionList,
                              value:  _verificationTasks[index]['partitionName'],
                              callback: (val) {
                                _verificationTasks[index]['partitionName'] = val == null ? '' : val['name'];
                                _verificationTasks[index]['partitionId'] =  val == null ? '' : val['id'];
                                _partitionId =  val == null ? '' : val['id'];
                                setState(() {});
                                _companys(index, _verificationTasks[index]['partitionId']);
                              }
                            )
                          ),
                          FormCheck.formRowItem(
                            ...
                            child: DownInput(
                              hitStr: '请选择区域企业',
                              data: _companyList,
                              value: _verificationTasks[index]['companyName'],
                              beforeClick: () {
                                if(_verificationTasks[index]['partitionName'] ==''
                                    || _verificationTasks[index]['partitionName'] == null
                                    || _verificationTasks[index]['partitionId'] != _partitionId
                                ){
                              ...
                              callback: (val) {
                                _verificationTasks[index]['companyName'] =val == null ? '' : val['name'];
                                _verificationTasks[index]['companyId'] = val == null ? '' : val['id'];
                                _verificationTasks[index]['access'] = val == null ? '' : val['emergencyContact']+','+val['emergencyPhone'];
                                _companyPlace = val == null ? [] : val['companyPlace'];
                                _companyPlaceId = val == null ? '' : val['id'];
                                setState(() {});
                              }
                            )
                          ),
                          FormCheck.formRowItem(
                            ...
                            child: DownInput(
                              hitStr: '请选择装置区',
                              value: _verificationTasks[index]['placeName'],
                              data: _companyPlace,
                              beforeClick: () {
                                if(_verificationTasks[index]['companyName'] ==''
                                    || _verificationTasks[index]['companyName'] == null
                                    || _verificationTasks[index]['companyId'] != _companyPlaceId
                                ){
                              ...
                              callback: (val) {
                                _verificationTasks[index]['placeId'] = val == null ? '' : val['id'];
                                _verificationTasks[index]['placeName'] = val == null ? '' : val['name'];
                                _verificationTasks[index]['longitude'] = val == null ? '' : val['longitude'];
                                _verificationTasks[index]['latitude'] = val == null ? '' : val['latitude'];
                                setState(() {});
                              }
                            )
                          ),
                          ...
                          FormCheck.formRowItem(
                            ...
                            child:DownInput(
                              hitStr: '请选择发布人',
                              value:_processorStr(_verificationTasks[index]['inspector']),
                              data: _peoples,
                              more: true,
                              callback: (val) {
                                _verificationTasks[index]['inspector'] = val;
                                setState(() {});
                              },
                            )
                          ),
                          FormCheck.formRowItem(
                            ...
                            child: TimeSelect(
                              ...
                              hintText: "请选择执行时间",
                              callBack: (time) => timeChange(time,index)
                            )
                          ),
                          FormCheck.formRowItem(
                            padding: false,
                            ...
                            child: FormCheck.inputWidget(
                              disabled: false,
                              hintText: _verificationTasks[index]['access']==''
                                ?'请输入企业对接人'
