...
class _DeviceState extends State<Device> {
                ...
                child: Column(
                  ...
                  children: [
                    Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
                      ...
                      Expanded(
                        child: Text('${diviceList[index]['name']}',
                            style: TextStyle(
                                fontSize: sp(28.0),
                      ...
                      Container(
                          ...
                          child: Center(
                            ...
                            style: TextStyle(
                              color: diviceList[index]['status'] == 1
                                  ? Color(0XFF90CC00)
                                  : Colors.red,
                              fontSize: sp(24.0),
                            ),
                    ...
                    Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            _itemData(
                                name: '监测设备',
                                value: '${diviceList[index]['source']}'),
                            Padding(
                              padding: EdgeInsets.symmetric(vertical: px(12.0)),
                              child: _itemData(
                                  name: '出场编号',
                                  value: '${diviceList[index]['code']}'),
                            ),
  ...
  Widget _itemData({String? name, String? value}) {
    return Text.rich(
      TextSpan(
        text: '$name：',
        style: TextStyle(fontSize: sp(26.0), color: Color(0XffCCD9FF)),
        children: <TextSpan>[
          TextSpan(
              text: '$value',
              style: TextStyle(fontSize: sp(28.0), color: Color(0XFFFFFFFF)))
        ],
      ),
    );
  }
