...
class _MapPageState extends State<MapPage> with AutomaticKeepAliveClientMixin{
  ...
  void initState() {
    ...
    if(StorageUtil().getJSON(StorageKey.RealStationInfo) != null){
      ...
      Future.microtask(() =>
          context.read<HomeModel>().getSiteList(StorageUtil().getJSON(StorageKey.RealStationInfo))
      );
    }else{
      _realStationInfo();
    }
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                child: Image.asset('assets/icon/other/task.png',width: px(34),height: px(40),),
              ),
              Text(
                '您有3条任务需要处理',
                style: TextStyle(
              ...
              Spacer(),
              Icon(Icons.keyboard_arrow_right,size: px(50.0),color: Color(0xff4D7CFF),)
            ],
          ),
        ),
      )
                      ...
                      child: Builder(builder: (context) {
                        return  GestureDetector(
                          child: Container(
                            ...
                            child: Image.asset('assets/images/home/layer.png'),
                          ),
                          onTap: (){
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.white,
                              borderRadius: BorderRadius.circular(px(24.0)),
                            ),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              crossAxisAlignment: CrossAxisAlignment.center,
                              children: [
                                Icon(Icons.credit_card,size: sp(28.0),
                                ...
                                Text('  列表模式',
                                  style: TextStyle(
                                    ...
                                    color: _bottomType == cardType.List
                                        ? Color(0xff4D7CFF)
                                        :Color(0xff848C99),
                                    fontWeight: _bottomType == cardType.List
                                        ? FontWeight.bold
                                        :FontWeight.w500,
                                  ),
                                )
  ...
  Widget getListView() {
    return Container(
      decoration: BoxDecoration(
        color: _bottomType == cardType.List ? Color(0xffffffff) : Color(0xffF2F4FA),
        ...
        child:  ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return _bottomType == cardType.List
              ? _typeList(index)
              : WarnCard(data:_alarmData[index],);  // WarnCard 卡片模式
          },
        ...
        children: [
          Row(
            children: [
              ...
              Spacer(),
              GestureDetector(
                child: Icon(Icons.keyboard_arrow_right, color: Color(0xff8A9099), size: sp(40)),
              ),
            ],
          ),
          Row(
            children: [
              ...
              Spacer(),
              GestureDetector(
                child: Text('${_alarmData[index]['time']}',style: TextStyle(fontSize: sp(24),color: Color(0xffC4C4C5))),
              ),
            ],
          )
        ],
