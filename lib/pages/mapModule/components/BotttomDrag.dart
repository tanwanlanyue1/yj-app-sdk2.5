...
GlobalKey<_BottomDragWidgetState> BottomDragWidgetKey = GlobalKey();
...
class _BottomDragWidgetState extends State<BottomDragWidget> {
  ...
  bool _show = false; //搜索栏的显示隐藏

  setBottomState(bool state) {
    final _homeModel = context.read<HomeModel>();
    _homeModel.setBottomDrawer(state);
    setState(() {
      _show = state;
    });
  }
      ...
      children: <Widget>[
        ...
        Align(
          ...
          child:AnimatedCrossFade(
            firstChild:widget.dragContainer,
